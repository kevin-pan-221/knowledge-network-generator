...
const KnowledgeGraph = ({ graphData })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const link = svgGroup.append("g").attr("class", "links").selectAll("line").data(links).enter().append("line").style("stroke", (d)=>{
            const weight = d.weight;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2f$src$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.interpolateBlues(Math.pow(weight, 3)); // blue link color scales exponentially
        }).style("stroke-width", 2);
        const node = svgGroup.append("g").attr("class", "nodes").selectAll("circle").data(nodes).enter().append("circle").attr("r", 10).style("fill", "skyblue").call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$d3$2f$src$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.drag().on("start", (event, d)=>{
        ...
        const label = svgGroup.append("g").attr("class", "labels").selectAll("text").data(nodes).enter().append("text").attr("dx", 12).attr("dy", 4).text((d)=>d.id);
        simulation.on("tick", ()=>{
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__33d31d._.js.map